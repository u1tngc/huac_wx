...
def make_head():
    ...
    html.append('<link rel="stylesheet" type="text/css" href="../static/WX0C0001.css" /> ')
    html.append('<style>')
    html.append('@font-face {')
    html.append('font-family: "japanese";')
    html.append('src: url(../static/fonts/GenShinGothic-Monospace-Medium.ttf);')
    html.append('}')
    html.append('body{')
    html.append('font-family: "japanese"')
    html.append('}')
...
def convertToPdf(text, nowdate,path):
    ...
    with open('/home/ubuntu/huac_wx/huac_wx/templates/天気概況.html', 'w', encoding='utf-8') as file:
        file.write(text)
    url = '/home/ubuntu/huac_wx/huac_wx/templates/天気概況.html'
    return url
